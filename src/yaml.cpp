  ...
  shape_msgs::msg::SolidPrimitive & primitive)
{
  ...
  primitive.dimensions[0] = node["dimensions"][0].as<double>();
  primitive.dimensions[1] = node["dimensions"][1].as<double>();
  if (node["dimensions"].size() > 2) {
    primitive.dimensions[2] = node["dimensions"][2].as<double>();
  }
  return true;
}
