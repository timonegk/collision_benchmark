...
parameters = [
  ...
  {'name': 'robot_description_kinematics_file',     'description': 'Path to the MoveIt kinematics file',              'default': PathJoinSubstitution([FindPackageShare('elise_moveit_config'), 'config', 'kinematics.yaml'])},
  {'name': 'robot_description_joint_limits_file',   'description': 'Path to the MoveIt joint limits file',            'default': PathJoinSubstitution([FindPackageShare('elise_moveit_config'), 'config', 'joint_limits.yaml'])},
  {'name': 'config_file',                           'description': 'Path to the reach study configuration YAML file', 'default': PathJoinSubstitution([FindPackageShare('benchmark'), 'config', 'hydrogen.yaml'])},
  {'name': 'config_name',                           'description': 'Reach study configuration name',                  'default': 'reach_study'},
  {'name': 'results_dir',                           'description': 'Directory in which to save reach study results',  'default': PathJoinSubstitution([FindPackageShare('benchmark'), 'config', 'results'])},
]
